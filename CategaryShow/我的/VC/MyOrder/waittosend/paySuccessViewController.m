...
- (void)viewDidLoad {
    ...
    [MobClick endEvent:@"trade_success" label:[SelfPersonInfo shareInstance].userModel.username];
...
//        WCLLog(@"%@--%@",responseObject,error);
        if ([self checkHttpResponseResultStatus:responseObject]) {
            ...
            share.shareUrl = [[[[responseObject objectForKey:@"data"] arrayForKey:@"img_urls"] firstObject] stringForKey:@"img"];
            share.ordersn=_ordersn;
