...
-(void)createTableView    //createtable
{
    ...
    clothesDetailTable = [[UITableView alloc] initWithFrame:CGRectMake(0, NavHeight, SCREEN_WIDTH,[ShiPeiIphoneXSRMax isIPhoneX]?SCREEN_HEIGHT-74-84:SCREEN_HEIGHT - 64  - 50) style:UITableViewStylePlain];
   ...
   [clothesDetailTable registerClass:[ComoanySaleDDDtailViewCell class] forCellReuseIdentifier:NSStringFromClass([ComoanySaleDDDtailViewCell class])];
    ...
    UIView *priceLowView = [[UIView alloc] initWithFrame:CGRectMake(0,[ShiPeiIphoneXSRMax isIPhoneX]?SCREEN_HEIGHT-74-84:SCREEN_HEIGHT-64 - 50, SCREEN_WIDTH / 3, 50)];
    ...
    UIButton *buttonSave = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH / 3,[ShiPeiIphoneXSRMax isIPhoneX]?SCREEN_HEIGHT-84-74: SCREEN_HEIGHT-64 - 50, SCREEN_WIDTH / 3 , 50)];
    ...
    UIButton *buttonBuy = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH / 3 * 2,[ShiPeiIphoneXSRMax isIPhoneX]?SCREEN_HEIGHT-84-74:SCREEN_HEIGHT -64- 50, SCREEN_WIDTH / 3 , 50)];
...
-(void)payForClothes
{
    ...
    [postData postData:URL_AddClothesCar PostParams:params finish:^(BaseDomain *domain, Boolean success) {
        if ([self checkHttpResponseResultStatus:postData]) {
            [MobClick event:@"place_order" label:[NSString stringWithFormat:@"%@--%@",[SelfPersonInfo shareInstance].userModel.username,[_dataDic stringForKey:@"goods_name"]]];
...
//    [params setObject:[_dataDic stringForKey:@"num"] forKey:@"num"];
    [postData postData:URL_AddClothesCar PostParams:params finish:^(BaseDomain *domain, Boolean success) {
        ...
        if ([self checkHttpResponseResultStatus:postData]) {
            [MobClick event:@"add_cart" label:[NSString stringWithFormat:@"%@--%@",[SelfPersonInfo shareInstance].userModel.username,[_dataDic stringForKey:@"goods_name"]]];
