...
{
    if (sender.tag == 2) {
        UIImageView *img = [self.contentView viewWithTag:3000];
        [img setImage:[UIImage imageNamed:@"fontChoose"]];
        UIImageView *imge = [self.contentView viewWithTag:3001];
        [imge setImage:[UIImage imageNamed:@"font"]];
    } else {
        UIImageView *img = [self.contentView viewWithTag:3001];
        [img setImage:[UIImage imageNamed:@"fontChoose"]];
        
        UIImageView *imge = [self.contentView viewWithTag:3000];
        [imge setImage:[UIImage imageNamed:@"font"]];
    }
