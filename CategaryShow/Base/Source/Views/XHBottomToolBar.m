...
- (UIButton *)shareButton {
    if (!_shareButton) {
        ...
        [_shareButton setBackgroundImage:[UIImage imageNamed:@"download"] forState:UIControlStateNormal];
        _shareButton.frame = CGRectMake(self.frame.size.width - 40, 5, 32, 32);
