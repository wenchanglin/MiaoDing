...
+(NSDictionary*) parstString:(NSString*) jsonString{
    
    JSONDecoder *jd=[[JSONDecoder alloc] init];
    
    return [jd objectWithUTF8String:(const unsigned char *)[jsonString UTF8String] length:(unsigned int)[jsonString length]];
