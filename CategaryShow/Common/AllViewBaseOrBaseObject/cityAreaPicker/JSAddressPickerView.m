...
- (void)setBaseView {
    ...
    UIView *selectView = [[UIView alloc] initWithFrame:CGRectMake(0,[ShiPeiIphoneXSRMax isIPhoneX]?height-124-210:height -84 -210, width, 30)];
    ...
    [ensureBtn.titleLabel setFont:[UIFont systemFontOfSize:14]];
    ...
    self.pickView = [[UIPickerView alloc] initWithFrame:CGRectMake(0,[ShiPeiIphoneXSRMax isIPhoneX]?height-180-124:height - 180-84 , width,  50+180)];
