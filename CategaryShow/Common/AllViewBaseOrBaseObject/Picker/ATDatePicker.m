...
- (void)show {
    ...
    __weak ATDatePicker *weakSelf = self;
...
- (UIButton *)sureButton {
    if (!_sureButton) {
        ...
        [_sureButton setTitleColor:getUIColor(Color_WearClothesPlaceHolder) forState:UIControlStateNormal];
...
- (UIButton *)cancelButton {
    if (!_cancelButton) {
        ...
        [_cancelButton setTitleColor:getUIColor(Color_WearClothesPlaceHolder) forState:UIControlStateNormal];
