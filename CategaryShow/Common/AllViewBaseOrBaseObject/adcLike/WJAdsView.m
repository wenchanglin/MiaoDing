...
- (void)layoutSubviews{
    ...
    .widthIs(7)
    .heightIs(13.5);
    [leftImg setImage:[UIImage imageNamed:@"leftDes"]];
    [leftImg setHidden:YES];
    ...
    .widthIs(7)
    .heightIs(13.5);
    [rightImg setImage:[UIImage imageNamed:@"rightDes"]];
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    if (index == 0) {
        [leftImg setHidden:YES];
        [rightImg setHidden:NO];
    } else if (containtViews.count - 1) {
        [leftImg setHidden:NO];
        [rightImg setHidden:YES];
    } else {
        [leftImg setHidden:NO];
        [rightImg setHidden:NO];
    }
...
- (void)setMinHorizontalPadding:(float)minHorizontalPadding1{
    ...
    containRect.size.width             = 498 / 2;
    mainContainView.frame              = containRect;
    mainContainView.center             = self.center;
