...
-(instancetype)initWithImgUrls:(NSArray *)urlStrArr fram:(CGRect)frame intro:(NSArray *)stringArr
{
    self = [super init];
    if (self) {
        ...
        self.StrArr = stringArr;
        __weak CircleScrollView *weakSelf = self;
        ImageContentView *contentView = [[ImageContentView alloc]initWithContentFrame:CGRectMake(0,0,frame.size.width,frame.size.height) andimgUrlStr:[urlStrArr lastObject] andIntroStr:[stringArr lastObject] andBtnBlock:^(void) {
        ...
        }else
        {
            ...
            __weak CircleScrollView *weakSelf = self;
            ImageContentView *contentView1 = [[ImageContentView alloc]initWithContentFrame:CGRectMake(frame.size.width * (urlStrArr.count+1),0,frame.size.width,frame.size.height) andimgUrlStr:[urlStrArr firstObject] andIntroStr:[stringArr firstObject] andBtnBlock:^(void) {
...
{
    if (!_pageControl) {
        _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(self.frame.size.width - 120,self.frame.size.height-41, 90,15)];
