...
//    leftView.frame = CGRectMake(self.frame.size.width / 2  - 30, (self.frame.size.height-20)/2, 20, 20);
    InfoLabel.frame = CGRectMake(self.frame.size.width / 2 - 160, (self.frame.size.height-20)/2, 320, 20);
