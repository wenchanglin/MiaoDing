...
//    [flowLayout setMinimumInteritemSpacing:43];
    ...
    position = [[UICollectionView alloc]initWithFrame:CGRectMake(10, 12, SCREEN_WIDTH - 20,  (SCREEN_WIDTH - 60) / 4) collectionViewLayout:flowLayout];
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_delegate respondsToSelector:@selector(positionClcik:)]) {
        [_delegate positionClcik:indexPath.item];
    }
}
