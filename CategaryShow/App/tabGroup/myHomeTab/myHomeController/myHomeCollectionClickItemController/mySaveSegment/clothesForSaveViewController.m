...
@interface clothesForSaveViewController ()<UITableViewDelegate, UITableViewDataSource>
...
-(void)createHaveSave
{
    haveSaveTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - 64 - 50) style:UITableViewStyleGrouped];
...
//    haveSaveCollection = [[UICollectionView alloc]initWithFrame:CGRectMake(10, 0, SCREEN_WIDTH - 20, SCREEN_HEIGHT - 64 - 20) collectionViewLayout:flowLayout1];
//    
...
//    haveSaveCollection.backgroundColor = getUIColor(Color_myOrderBack);
...
//    
//    return CGSizeMake((SCREEN_WIDTH - 30) / 2, (SCREEN_HEIGHT - 40) / 3);
//}
