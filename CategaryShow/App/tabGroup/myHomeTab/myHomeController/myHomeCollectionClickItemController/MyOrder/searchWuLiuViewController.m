...
-(void)getDatas
{
    ...
    [params setObject:_ems_no forKey:@"ems_no"];
    [params setObject:_ems_com forKey:@"ems_com"];
    [getData getData:URL_SearchWuLiu PostParams:params finish:^(BaseDomain *domain, Boolean success) {
