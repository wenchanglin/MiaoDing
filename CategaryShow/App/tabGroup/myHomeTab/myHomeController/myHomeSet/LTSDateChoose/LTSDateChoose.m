...
- (void)addUI{
    ...
    
    {
        ...
        view.backgroundColor  = lineColor;
        [self.alertView addSubview:view];
        view.frame = CGRectMake(CGRectGetMaxX(self.leftBtn.frame),[ShiPeiIphoneXSRMax isIPhoneX]?CGRectGetMaxY(self.dateP.frame)-25:CGRectGetMaxY(self.dateP.frame), 0.5, kDateBtnHeight);
...
//        NSDate* maxDate = [[NSDate alloc] initWithString:@"2099-01-01 00:00:00 -0500"];
        ...
        NSTimeInterval  oneDay = 24*60*60*1*365;
        
        NSDate *minDate = [[NSDate alloc] initWithTimeIntervalSinceNow:-oneDay * 40 ];
        NSDate *maxDate = [[NSDate alloc] initWithTimeIntervalSinceNow:-oneDay];
...
- (UIButton *)leftBtn{
    if (!_leftBtn) {
        ...
        self.leftBtn.frame = CGRectMake(0,[ShiPeiIphoneXSRMax isIPhoneX]?CGRectGetHeight(self.alertView.frame)-kDateBtnHeight-25:CGRectGetHeight(self.alertView.frame)-kDateBtnHeight, SCREEN_WIDTH/2, kDateBtnHeight);
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        self.rightBtn.frame = CGRectMake(SCREEN_WIDTH/2,[ShiPeiIphoneXSRMax isIPhoneX]?CGRectGetHeight(self.alertView.frame)-kDateBtnHeight-25:CGRectGetHeight(self.alertView.frame)-kDateBtnHeight , SCREEN_WIDTH/2, kDateBtnHeight);
