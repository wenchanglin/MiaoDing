...
- (void)layoutSubviews {
    ...
    self.imageView.frame = CGRectInset(self.bounds, 0, 0);
...
- (CGPathRef)maskPath {
    ...
    [path moveToPoint:CGPointMake(-imageViewX, -imageViewY + realH / 6)];
    ...
    [path addLineToPoint:CGPointMake(-imageViewX, -imageViewY+ realH + realH / 6)];
    [path closePath];
