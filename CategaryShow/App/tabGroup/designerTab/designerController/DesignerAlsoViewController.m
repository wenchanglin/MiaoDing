...
-(UIView *)setPageViewControllers
{
    if (!_RCSegView) {
        ...
        MySegMentViewNew * rcs=[[MySegMentViewNew alloc]initWithFrame:CGRectMake(0, 0, Main_Screen_Width, Main_Screen_Height) controllers:controllers titleArray:titleArray ParentController:self lineWidth:25 lineHeight:2.0 butHeight:30 viewHeight:64 showLine:YES];
