...
- (void)loadUI{
    ...
    _backgroundView.backgroundColor = getUIColor(Color_background);
...
- (UIButton *)addButton:(CGRect)frame title:(NSString *)title tag:(NSInteger)tag{
    ...
    [button setBackgroundImage:st_imageWithColor(getUIColor(Color_background)) forState:UIControlStateNormal];
    [button setBackgroundImage:st_imageWithColor(getUIColor(Color_background)) forState:UIControlStateHighlighted];
