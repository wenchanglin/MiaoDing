...
@property (nonatomic,copy) void (^clAction)(void);
// 重置密码界面
...
//    [self addSubview:headIcon];
    ...
    loginBtn.backgroundColor = getUIColor(Color_mainColor);
    ...
    [dlzcBtn setTitleColor:getUIColor(Color_mainColor) forState:0];
    ...
    [wjBtn setTitleColor:getUIColor(Color_mainColor) forState:0];
